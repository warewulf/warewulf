...
func init() {
	...
	baseCmd.PersistentFlags().BoolVar(&OciNoHttps, "ocinohttps", false, "Ignore wrong TLS certificates, superseedes env WAREWULF_OCI_NOHTTPS")
	baseCmd.PersistentFlags().StringVar(&OciUsername, "ociusername", "", "Set username for the access to the registry, superseedes env WAREWULF_OCI_USERNAME")
	baseCmd.PersistentFlags().StringVar(&OciPassword, "ocipasswd", "", "Set password for the access to the registry, superseedes env WAREWULF_OCI_PASSWORD")
}
