...
provisions the kernel automatically for any node configured to use that image.

You can see what kernels are available in imported images by using the ``wwctl
image kernels`` command.
