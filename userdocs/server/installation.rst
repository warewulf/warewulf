...
.. code-block:: console
   ...
   # dnf install https://github.com/warewulf/warewulf/releases/download/v4.7.1/warewulf-4.7.1-1.el9.x86_64.rpm
...
.. code-block:: console
   ...
   # zypper install https://github.com/warewulf/warewulf/releases/download/v4.7.1/warewulf-4.7.1-1.suse.lp156.x86_64.rpm
...
.. code-block:: bash
   ...
   curl -LO https://github.com/warewulf/warewulf/releases/download/v4.7.1/warewulf-4.7.1.tar.gz
   tar -xf warewulf-4.7.1.tar.gz
   cd warewulf-4.7.1
...
.. code-block:: bash
   ...
   cd warewulf
   git checkout main # or switch to a tag like 'v4.7.1'
   make all && sudo make install
